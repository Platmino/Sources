...
local function CheckItemIndex(Item_Index, Method)
...
function Menu:SetToolTip(Enabled, Content, Item)
    ToolTip = {
        Enabled = Enabled,
        Content = Content,
        Item = Item
...
function Menu.Container(Tab_Name, Container_Name, Side)
    ...
    function Container:UpdateSize(Height, Item)
        self.Height += Height
...
function Menu.Label(Tab_Name, Container_Name, Name, ToolTip)
...
function Menu.Button(Tab_Name, Container_Name, Name, Callback, ToolTip)
    local Container = GetContainer(Tab_Name, Container_Name)
...
function Menu.TextBox(Tab_Name, Container_Name, Name, Value, Callback, ToolTip)
    local Container = GetContainer(Tab_Name, Container_Name)
...
function Menu.CheckBox(Tab_Name, Container_Name, Name, Boolean, Callback, ToolTip)
    local Container = GetContainer(Tab_Name, Container_Name)
...
function Menu.Hotkey(Tab_Name, Container_Name, Name, Key:EnumItem, Callback, ToolTip)
    local Container = GetContainer(Tab_Name, Container_Name)
    ...
    function Hotkey:GetValue()--, string
...
function Menu.Slider(Tab_Name, Container_Name, Name, Min, Max, Value, Unit, Scale, Callback, ToolTip)
    local Container = GetContainer(Tab_Name, Container_Name)
    ...
    function Slider:Update(Percentage)
...
function Menu.ColorPicker(Tab_Name, Container_Name, Name, Color, Alpha, Callback, ToolTip)
    local Container = GetContainer(Tab_Name, Container_Name)
    ...
    function ColorPicker:GetValue()--, number
...
function Menu.ComboBox(Tab_Name, Container_Name, Name, Value, Value_Items, Callback, ToolTip)
    local Container = GetContainer(Tab_Name, Container_Name)
...
function Menu.MultiSelect(Tab_Name, Container_Name, Name, Value_Items, Callback, ToolTip)
    local Container = GetContainer(Tab_Name, Container_Name)
...
function Menu.ListBox(Tab_Name, Container_Name, Name, Multi, Value_Items, Callback, ToolTip)
    local Container = GetContainer(Tab_Name, Container_Name)
    local List = Instance.new("ScrollingFrame")
    local ListLayout = Instance.new("UIListLayout")
...
function Menu.Keybinds()
    ...
    function Keybinds:SetPosition(Position)
...
function Menu.Indicators()
    ...
    function Indicators:SetPosition(Position)
        self.self.Position = Position
    end

    function Indicators:TPosition(Position)
        TweenService:Create(self.self,TweenInfo.new(0.03,Enum.EasingStyle.Quad,Enum.EasingDirection.In),{Position = Position}):Play()
    end
